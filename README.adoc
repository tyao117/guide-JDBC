...
This guide will also be using a sample database from this site: https://github.com/datacharmer/test_db
**NOTE** If you have not setup mySQL before, make a root password during the setup, or it will be hard to connect to the mysql database.
