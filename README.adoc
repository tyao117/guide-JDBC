...
Learn how to create a service with JAX-RS, JSON-P, mySQL, and Open Liberty.
...
For this guide: please install the mySQL Community Server from this site: https://dev.mysql.com/downloads/

Go through the mySQL setup for the server. 
...
Now the testuser needs to be installed into the mysql server:
----
