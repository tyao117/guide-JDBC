...
Learn how to create a JDBC service with JAX-RS, JSON-P, and Open Liberty.
...
This guide will be unique as it will require some installation and/or prior knowledge. The mySQL code in this will be unique to your username and your pass.
