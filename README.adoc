...
For now, the database that will be used is the employee. The employee database can be installed here: https://github.com/datacharmer/test_db. Download the repo, and run the command 
----
git clone https://github.com/datacharmer/test_db
----

After the command, the database needs to be populated. 
----
...
Create the JAX-RS resource class in the `src/main/java/io/openliberty/guides/rest/TestResource.java` file:
[source,java]
----
